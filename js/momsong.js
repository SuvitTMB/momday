...
function DisplaySong(n) {
  ...
  if(n==1) {
    ...
    NameVDO = '<div><iframe width="340" height="191" src="https://www.youtube.com/embed/ufaM2-ca9to" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>';
    ...
    NameVDO = '<div><iframe width="270" height="152" src="https://www.youtube.com/embed/gU7ghmJ0iCE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>';
    ...
    NameVDO = '<div><iframe width="280" height="157" src="https://www.youtube.com/embed/WEFOVJwnaVw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>';
    ...
    NameVDO = '<div><iframe width="290" height="163" src="https://www.youtube.com/embed/COlNNFakOrw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>';
    ...
    NameVDO = '<div><iframe width="300" height="169" src="https://www.youtube.com/embed/bimw4o6wNtA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>';
