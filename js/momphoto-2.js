...
function showData(doc) {
	...
	cell2.innerHTML = "<center><img src="+doc.data().LinePicture+" style='width:35px;height:35px;'></center>";
	cell3.innerHTML = doc.data().LineName;
	//cell4.innerHTML = doc.data().empID;
	cell4.innerHTML = doc.data().PostMemo;
	cell5.innerHTML = doc.data().PostDate;
}
